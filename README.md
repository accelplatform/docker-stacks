...
```sh
# Gitクローン
git clone -b 2025autumn-postgres https://github.com/accelplatform/docker-stacks.git
```
...
sudo rm -rf data/cassandra data/httpd data/mailpit data/postgresql data/resin data/solr data/accelstudio-testing-agent
# コンテナの起動
docker compose up -d
```
