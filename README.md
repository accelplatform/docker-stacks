...
```sh
# Gitクローン
git clone -b 2026spring-oracle https://github.com/accelplatform/docker-stacks.git
```
...
sudo rm -rf data/cassandra data/httpd data/mailpit data/oracle data/resin data/solr data/accelstudio-testing-agent
# コンテナの起動
docker compose up -d
```
